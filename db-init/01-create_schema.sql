...
DROP TABLE POST_COMMENTS CASCADE CONSTRAINTS;
DROP TABLE POSTS CASCADE CONSTRAINTS;
DROP TABLE FRIENDSHIP_INVITATIONS CASCADE CONSTRAINTS;
...
DROP TABLE EXERCISES_MUSCLES CASCADE CONSTRAINTS;
DROP TABLE EXERCISES CASCADE CONSTRAINTS;
DROP TABLE MUSCLES CASCADE CONSTRAINTS;
DROP TABLE USERS CASCADE CONSTRAINTS;

DROP SEQUENCE TOKEN_SEQUENCE;

DROP FUNCTION ARE_FRIENDS;
DROP FUNCTION GET_FRIENDS_COUNT;
DROP FUNCTION GET_USER_DAILY_EXERCISE_COUNT;
DROP FUNCTION GET_USERS_EXERCISES_IN_PERIOD;
DROP FUNCTION GET_EXERCISE_RANKING;
DROP PROCEDURE GET_USER_FRIENDS_WITH_AVATAR;
DROP PROCEDURE GET_USER_FRIEND_REQUESTS_WITH_AVATAR;

DROP INDEX IDX_POST_DATE_ORDER;
DROP INDEX IDX_WORKOUT_START_DATE_ORDER;
